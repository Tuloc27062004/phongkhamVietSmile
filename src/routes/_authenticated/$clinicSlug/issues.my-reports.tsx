...
export const Route = createFileRoute("/_authenticated/$clinicSlug/issues/my-reports")({
  head: () => ({
    meta: [
      { title: "Báo cáo của tôi — GZV Clinic Platform" },
        ...
        {reports.length === 0 ? (
          <Card className="border-0 shadow-sm">
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <Link to={buildPath("/issues/report")} className="mt-2 text-sm text-blue-600 hover:underline">
                Gửi báo cáo mới
              </Link>
            </div>
          </Card>
