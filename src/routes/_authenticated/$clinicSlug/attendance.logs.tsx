...
export const Route = createFileRoute("/_authenticated/$clinicSlug/attendance/logs")({
  head: () => ({
    meta: [
      { title: "Dữ liệu máy chấm công — GZV Clinic Platform" },
      {
        name: "description",
      ...
      {
        property: "og:title",
        content: "Dữ liệu máy chấm công — GZV Clinic Platform",
      },
    ],
  }),
