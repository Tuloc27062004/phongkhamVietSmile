...
export const Route = createFileRoute("/_authenticated/$clinicSlug/system/devices")({
  head: () => ({
    meta: [
      { title: "Máy chấm công — GZV Clinic Platform" },
      {
        name: "description",
      ...
      {
        property: "og:title",
        content: "Máy chấm công — GZV Clinic Platform",
      },
    ],
  }),
