...
export const Route = createFileRoute("/_authenticated/$clinicSlug/attendance/daily")({
  head: () => ({
    meta: [
      { title: "Chấm công theo ngày — GZV Clinic Platform" },
      {
        name: "description",
      ...
      {
        property: "og:title",
        content: "Chấm công theo ngày — GZV Clinic Platform",
      },
    ],
  }),
